...
namespace FUMiniHotelManagement.DAL;
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<BookingReservation>(entity =>
        {
            ...
            entity.Property(e => e.BookingReservationId)
                    .ValueGeneratedOnAdd() // ✅ THAY THẾ ValueGeneratedNever()
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.HasIndex(e => e.EmailAddress, "UQ__Customer__49A14740D37EF25A").IsUnique();
